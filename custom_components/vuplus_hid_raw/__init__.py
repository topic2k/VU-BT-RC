...
COMMAND_LABELS = {
    "ok":"OK","up":"Pfeil hoch","down":"Pfeil runter","left":"Pfeil links","right":"Pfeil rechts",
    "volume_up":"Lautstärke +","volume_down":"Lautstärke -","channel_up":"Kanal +","channel_down":"Kanal -",
    "menu":"Menü","pvr":"PVR","mute":"Stumm","rewind":"Zurückspulen","forward":"Vorspulen","play":"Play",
    "pause":"Pause","record":"Aufnahme","stop":"Stop","radio":"Radio","help":"Hilfe","stb_power":"STB Power",
    "red":"Rot","green":"Grün","yellow":"Gelb","blue":"Blau",**{str(i):str(i) for i in range(10)},
    "epg":"EPG","audio":"Audio","teletext":"Teletext","subtitle":"Untertitel","speak":"Sprechen","tv":"TV",
    "exit":"Exit","left_0":"Links neben 0","right_0":"Rechts neben 0",
}
...
async def async_remove_entry(hass: HomeAssistant, entry: ConfigEntry) -> None:
    ...
    ir.async_create_issue(
        ...
        translation_placeholders={"name": getattr(entry, "title", "VU+-Fernbedienung")},
        data={
